...
<!-- Mirrored from preview.themeon.net/nifty/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2024 15:23:44 GMT -->
...
<head>
    ...
    <style type="text/css">
        /* @font-face {
            ...
            font-style: normal;
            font-weight: 300;
            src: url({{ asset('assets/css/font/normal.woff2') }});
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(https://preview.themeon.net/cf-fonts/s/poppins/5.0.11/latin/400/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 500;
            src: url(https://preview.themeon.net/cf-fonts/s/poppins/5.0.11/latin/500/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 700;
            src: url(https://preview.themeon.net/cf-fonts/s/poppins/5.0.11/latin/700/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(https://preview.themeon.net/cf-fonts/s/ubuntu/5.0.11/latin/400/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 500;
            src: url(https://preview.themeon.net/cf-fonts/s/ubuntu/5.0.11/latin/500/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 700;
            src: url(https://preview.themeon.net/cf-fonts/s/ubuntu/5.0.11/latin/700/normal.woff2);
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
            font-display: swap;
        }
    ...
    <link rel="stylesheet"
        href="assets/css/bootstrap.min.66c59451bbe016158b4aec61e40cb76ecbf0a3d3ff23ba206bdbffb9a89b97f5.css">

    <!-- Nifty CSS [ REQUIRED ] -->
    <link rel="stylesheet"
        href="assets/css/nifty.min.ef4dee33cb03225ab91107ec2905fe15f71a06ba22edcf1e480874b0fb882a31.css">
...
<body class="out-quart">
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <p>Scroll down to see quick links and overviews of your Server, To do list<br> Order status or get
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-7 text-sm">
                                                    <div
                                                        class="d-flex justify-content-between align-items-start px-3 mb-3">
                                                        Min Values
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="progress progress-md">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: 70%" aria-label="Incoming Progress" aria-valuenow="70"
                                            ...
                                            <div class="progress progress-md">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    style="width: 10%" aria-label="Outcome Progress"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-success text-white overflow-hidden mb-3">
                                        <div class="p-3 pb-2">
                                            <h5 class="mb-3"><i
                                                    class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i>
                                                HDD Usage</h5>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-info text-white overflow-hidden mb-3">
                                        <div class="p-3 pb-2">
                                            <h5 class="mb-3"><i
                                                    class="demo-psi-coin text-reset text-opacity-75 fs-2 me-2"></i>
                                                Earning</h5>
                                            <ul class="list-group list-group-borderless">
                                                <li
                                                    class="list-group-item p-0 text-reset d-flex justify-content-between align-items-start">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="card bg-purple text-white overflow-hidden mb-3">
                                        <div class="p-3 pb-2">
                                            <h5 class="mb-3"><i
                                                    class="demo-psi-basket-coins text-reset text-opacity-75 fs-2 me-2"></i>
                                                Sales</h5>
                                            <ul class="list-group list-group-borderless">
                                                <li
                                                    class="list-group-item p-0 text-reset d-flex justify-content-between align-items-start">
                                ...
                                <div class="card-body text-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 text-center ms-3">
                                            <p class="text-body-secondary">Lorem ipsum dolor sit amet, consectetuer
                                                adipiscing elit.</p>
                    ...
                    <div class="content__wrap">
                        ...
                        <div class="row gx-5 gy-5 gy-md-0">
                            <div class="col-md-4">
                                ...
                                <ul class="list-group list-group-borderless">
                                    <li class="list-group-item px-0">
                                        <div class="form-check ">
                                            <input id="_dm-todoList1" class="form-check-input" type="checkbox"
                                                checked>
                                            <label for="_dm-todoList1"
                                                class="form-check-label text-decoration-line-through">
                                                Find an idea <span
                                                    class="badge bg-danger text-decoration-line-through">Important</span>
                                            </label>
                                        </div>
                                    </li>
                                    <li class="list-group-item px-0">
                                ...
                                <div class="input-group mt-3">
                                    <input type="text" class="form-control form-control-sm"
                                        placeholder="Add new list" aria-label="Add new list"
                                        aria-describedby="button-addon">
                                    <button id="button-addon" class="btn btn-sm btn-secondary hstack gap-2"
                                        type="button">
                                ...
                                <div class="list-group list-group-borderless">
                                    <div class="list-group-item px-0 mb-2">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-check-label h5 mb-0" for="_dm-dbPersonalStatus">Show my
                                                personal status</label>
                                            <div class="form-check form-switch">
                                                <input id="_dm-dbPersonalStatus" class="form-check-input"
                                    ...
                                    <div class="list-group-item px-0 mb-2">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="form-check form-switch">
                                                <input id="_dm-dbOfflineContact" class="form-check-input"
                                                    type="checkbox">
                                            </div>
                                        </div>
                                    ...
                                    <div class="list-group-item px-0 mb-2">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-check-label h5 mb-0" for="_dm-dbMuteNotifications">Mute
                                                notifications</label>
                                            <div class="form-check form-switch">
                                                <input id="_dm-dbMuteNotifications" class="form-check-input"
                                                    type="checkbox">
                                            </div>
                                        </div>
                                        <span>Aenean commodo ligula eget dolor. Aenean massa.</span>
                                    ...
                                    <div class="list-group-item px-0 mb-2">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-check-label h5 mb-0"
                                                for="_dm-dbInvisibleMode">Invisible Mode</label>
                                            <div class="form-check form-switch">
                                                <input id="_dm-dbInvisibleMode" class="form-check-input"
                                                    type="checkbox" checked>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <!-- User quote  -->
                                <div
                                    class="d-flex align-items-center position-relative hv-grow-parent hv-outline-parent">
                                    <div class="flex-shrink-0">
                                        <img class="hv-gc hv-oc img-lg rounded-circle"
                                            src="assets/img/profile-photos/8.png" alt="Profile Picture"
                                            loading="lazy">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <a href="#"
                                            class="d-block stretched-link h5 link-offset-2-hover text-decoration-none link-underline-hover mb-0">Kathryn
                                            Obrien</a>
                                        Project manager
                                    </div>
                                </div>
                                ...
                                <figure class="d-flex flex-column align-items-center justify-content-center my-4">
                                    <blockquote class="blockquote mb-0">
                                        <p class="quote">Lorem ipsum dolor sit amet, consecte tuer adipiscing elit,
                                            sed diam nonummy nibh euismod tincidunt</p>
                                    </blockquote>
                                </figure>

                                <div class="border-top pt-3">
                                    <a href="#" class="btn btn-icon btn-link text-indigo"
                                        aria-label="Facebook button">
                                        <i class="demo-psi-facebook fs-4"></i>
                                    </a>
                                    <a href="#" class="btn btn-icon btn-link text-info"
                                        aria-label="Twitter button">
                                        <i class="demo-psi-twitter fs-4"></i>
                                    </a>
                                    <a href="#" class="btn btn-icon btn-link text-red"
                                        aria-label="Google plus button">
                                        <i class="demo-psi-google-plus fs-4"></i>
                                    </a>
                                    <a href="#" class="btn btn-icon btn-link text-orange"
                                ...
                                <div class="col-md-6 d-flex gap-1 align-items-center justify-content-md-end mb-3">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="btn-group dropdown">
                                            <button
                                                class="btn btn-icons btn-outline-light dropdown-toggle hstack gap-2"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                Options
                                                <span class="vr"></span>
                                                <span class="visually-hidden">Toggle Dropdown</span>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 22,
                                                    2024</span></td>
                                            <td>$45.00</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 24,
                                                    2024</span></td>
                                            <td>$245.30</td>
                                            <td class="text-center fs-5">
                                        ...
                                        <tr>
                                            ...
                                            <td>Teresa L. Doe</td>
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 15,
                                                    2024</span></td>
                                            <td>$77.99</td>
                                            <td class="text-center fs-5">
                                                <div class="d-block badge bg-info">Shipped</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>Teresa L. Doe</td>
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 12,
                                                    2024</span></td>
                                            <td>$18.00</td>
                                            <td class="text-center fs-5">
                                                <div class="d-block badge bg-success">Paid</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>Charles S Boyle</td>
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 17,
                                                    2024</span></td>
                                            <td>$658.00</td>
                                            <td class="text-center fs-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-body"><i class="demo-pli-clock"></i> May 19,
                                                    2024</span></td>
                                            <td>$45.58</td>
                                            <td class="text-center fs-5">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        {{-- <a href="index.html" class="brand-img stretched-link">
                            <img src="assets/img/uvccm-logo.jpg" alt="UVCCM Logo" class="UVCCM logo" width="16"
                                height="16">
                        </a> --}}


                        <!-- Brand title -->
                        <div style="color: #fff; font-weight: 900;font-size: 1.3rem;">UVCCM ZANZIBAR</div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="list-group list-group-borderless">
                                            ...
                                            <div
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="h5 d-block mb-0 stretched-link text-decoration-none">Support</a>
                                                    <small class="text-body-secondary">Have any questions ? please
                                                        don't hesitate to ask.</small>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="h5 d-block mb-0 stretched-link text-decoration-none">Security</a>
                                            ...
                                            <div
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="#"
                                                        class="h5 d-block mb-0 stretched-link text-decoration-none">Location</a>
                                                    <small class="text-body-secondary">From our location up here, we
                                                        kept in close touch.</small>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="list-group list-group-borderless">
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <a href="#"
                                                    class="h6 fw-normal mb-0 stretched-link text-decoration-none">Comment
                                                    sorting</a>
                                                <span class="badge bg-info rounded ms-auto">NEW</span>
                                            </div>
                                            <small class="text-body-secondary">You have 1,256 unsorted
                                                comments.</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="img-xs rounded-circle" src="assets/img/profile-photos/3.png"
                                                alt="Profile Picture" loading="lazy">
                                        </div>
                                        <div class="flex-grow-1">
                                            <a href="#"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    <div class="flex-shrink-0">
                                        <img class="img-sm rounded-circle" src="assets/img/profile-photos/4.png"
                                            alt="Profile Picture" loading="lazy">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
        ...
        <aside class="sidebar">
            <div class="sidebar__inner scrollable-content">
                ...
                <div class="sidebar__wrap">
                    <nav>
                        <div class="nav nav-underline nav-fill nav-component flex-nowrap border-bottom"
                    ...
                    <div id="nav-chat" class="tab-pane fade py-4 show active" role="tabpanel"
                        ...
                        <div class="list-group list-group-borderless">
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-start mb-2">
                                ...
                                <div class="flex-grow-1 ">
                                    <a href="#"
                                        class="h6 d-block mb-0 stretched-link text-decoration-none">Jack George</a>
                        ...
                        <!-- Friends Group -->
                        <h5 class="d-flex mt-5 px-3">Friends <span class="badge bg-success ms-auto">587 +</span>
                        </h5>
                        <div class="list-group list-group-borderless">
                            <a href="#" class="list-group-item list-group-item-action">
                    ...
                    <div id="nav-settings" class="tab-pane fade py-4" role="tabpanel"
                        ...
                        <div class="list-group list-group-borderless">
                            ...
                            <div class="list-group-item mb-1">
                                ...
                                <small class="text-body-secondary">Aenean commodo ligula eget dolor. Aenean
                                    massa.</small>
                            </div>
                            ...
                            <div class="list-group-item mb-1">
                                ...
                                <small class="text-body-secondary">Cum sociis natoque penatibus et magnis dis
    ...
    <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
    <div id="_dm-boxedBgContent" class="_dm-boxbg offcanvas offcanvas-bottom" data-bs-scroll="true"
        tabindex="-1">
    ...
    <script src="assets/js/bootstrap.min.705accd2201a27b32a1b95615e20fbb58fc9f3200388517b3a66f322ad955857.js"></script>


    <!-- Nifty JS [ OPTIONAL ] -->
    <script src="assets/js/nifty.min.b960437305df20c97b96bfb28e62b7d655ad70041fcfed38fae70d11012b2b58.js"></script>

    <!-- Plugin scripts [ OPTIONAL ] -->
    <script src="assets/pages/dashboard-1.min.b651fbd1a6f6a43e11bc01617b4481ab0edc4ba4582106c466d7ae2a9a9ac178.js"></script>


</body>


<!-- Mirrored from preview.themeon.net/nifty/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2024 15:25:19 GMT -->
